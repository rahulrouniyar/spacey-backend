"""
Django settings for spacey_backend project.
...
ALLOWED_HOSTS = ["spacey-backend.azurewebsites.net", "127.0.0.1", ".vercel.app"]
...
ROOT_URLCONF = "spacey_backend.urls"
...
WSGI_APPLICATION = "spacey_backend.wsgi.application"
